...
//
	...
	public static String getConfig(HttpServletRequest request,String urlindex) throws UnsupportedEncodingException {
		String urlString=""; 
		if(StringUtils.equals("1", urlindex)){
			 urlString =Global.getConfig("dingding.url1") ;
		}else if(StringUtils.equals("2", urlindex)){
			urlString = Global.getConfig("dingding.url2") ;
		}else if(StringUtils.equals("3", urlindex)){
			urlString = Global.getConfig("dingding.url3") ;
		}
